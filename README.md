...
```
composer require --prefer-dist atishrajput/yii2-swagger "*"
```

or add

```
"atishrajput/yii2-swagger": "*"
```
...
class SiteController extends Controller
{
    ...
    public function actions(): array
    {
        return [
            'docs' => [
                'class' => 'atishrajput\Yii2Swagger\SwaggerUIRenderer',
                'restUrl' => Url::to(['site/json-schema']),
            ],
            'json-schema' => [
                'class' => 'atishrajput\Yii2Swagger\OpenAPIRenderer',
